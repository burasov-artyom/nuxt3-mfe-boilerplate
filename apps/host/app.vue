...
const RemoteButton = defineAsyncComponent({
    ...
    // @ts-ignore
      loader: () => import('remote/ButtonTest'),
...
<template>
  ...
  <div>
    <TransitionRoot as="template" :show="sidebarOpen">
      <Dialog as="div" class=" inset-0 flex z-40 md:hidden" @close="sidebarOpen = false">
          ...
          <div class="relative flex-1 flex flex-col max-w-xs w-full bg-gray-800">
            ...
            <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
              ...
              <nav class="mt-5 px-2 space-y-2">
                <a v-for="item in navigation" :key="item.name" :href="item.href" class="group flex items-center px-2 py-2 text-base font-medium rounded-md" :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white']">
      ...
      <div class="flex-1 flex flex-col min-h-0 bg-gray-800">
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="mt-5 flex-1 px-2 space-y-1">
            <a v-for="item in navigation" :key="item.name" :href="item.href" class="group flex items-center px-2 py-2 text-sm font-medium rounded-md" :class="[item.current ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white']">
